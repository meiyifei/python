...
if __name__ == '__main__':
    ...
    with Pool(processes=4) as pool:
        ...
        #多任务时，指定timeout，如果返回结果超时，启用多个进程并行执行该任务
        multiple_results = [pool.apply_async(os.getpid, ()) for i in range(4)]
        print([res.get(timeout=1) for res in multiple_results])

        # make a single worker sleep for 10 secs
        #单任务超时会抛出TimeoutErroe异常
...
# -*- coding:utf-8 -*-
# Author:Mei
#多任务中某个子任务的返回结果的时间比设置的多任务返回结果的timeout还要大，会抛出异常
#result(多任务时间)>sub_result(子任务时间)>timeout(设定的多任务时间)
...
if __name__ == '__main__':
    ...
    for i in range(4):
        res = pool.apply_async(run_time, (i,))
        print(res.get(timeout=1))
    pool.close()
    pool.join()
    print("结束标志")
...
Traceback (most recent call last):
  File "C:/Users/admin/PycharmProjects/test_debug/venv/sync_process.py", line 20, in <module>
    print(res.get(timeout=1))
  File "C:\Users\admin\AppData\Local\Programs\Python\Python36\lib\multiprocessing\pool.py", line 640, in get
    raise TimeoutError
...
# -*- coding:utf-8 -*-
# Author:Mei
#result(多任务时间)>timeout(设定的多任务时间)>sub_result(子任务时间)
#不会抛出异常，而采用多进程并行执行
...
```
0 93364 80572 1.0269594192504883
0
1 86164 80572 1.0463781356811523
1
2 93928 80572 1.0381133556365967
4
3 93760 80572 1.0239965915679932
9
4 93364 80572 1.0301671028137207
16
5 86164 80572 1.0466201305389404
25
结束标志
```
...
```
0 74736 3944 0.3165290355682373
1 93244 3944 0.37495994567871094
5 93244 3944 0.09528946876525879
6 93244 3944 0.20659899711608887
3 85944 3944 0.9332365989685059
2 54184 3944 0.9954912662506104
4 74736 3944 0.9823977947235107
8 85944 3944 0.24693751335144043
9 54184 3944 0.27149105072021484
7 93244 3944 0.8634071350097656
结束标志
```
